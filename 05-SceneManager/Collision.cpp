...
bool CCollision::AABBCheck(float l1, float t1, float r1, float b1, float l2, float t2, float r2, float b2)
{
	// overlap if intervals intersect on both axes
	return (l1 < r2) && (r1 > l2)    // horizontal overlap
		&& (t1 < b2) && (b1 > t2);
}
